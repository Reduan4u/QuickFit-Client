...
const page = () => {
    return (
        <div>
            <div><Ebanner image={"https://img.freepik.com/free-photo/modern-sport-composition-with-template_23-2148000566.jpg?t=st=1709658957~exp=1709662557~hmac=d910b3cb2deeef7a419f0cc72162548e1b50bc150f6c76ffddee79375c0409e2&w=740"} heading={"Fitness"}></Ebanner>
            </div>

            <div>
                <div className="bg-three opacity-95 py-5">
                    <motion.div
