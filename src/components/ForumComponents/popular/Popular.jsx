...
const Popular = () => {
    ...
    const [posts, setPosts] = useState([]);
       ...
       const getData = async() => {
        await axiosPublic.get(`/forum/find/popularpost`)
        .then((data)=>{
           setPosts(data.data);
                ...
                <div>
                    <div className='flex items-center justify-start gap-6'>
                        ...
                        <div className='border border-gray-700 flex items-center justify-center gap-2 px-1 py-1 rounded-sm'>
                            <FaAngleUp className='text-[#818CF8]' /> <span className='text-[#2a4bf1ee] text-[14px]'>{post?.likesCount}</span>
                        </div>
                        ...
                        <div>
                            ...
                            <div className='flex items-center justify-start gap-2 mt-4'>
                                ...
                                <div className='text-gray-700 text-[15px] pb-1'> . </div>
                                <p className='text-gray-700 text-[14px]'>{post?.commnetsCount} comments</p>
                            </div>
                        </div>
