        ...
        <div className='bg-white p-5 rounded shadow-xl'>
            ...
            <Marquee>
                {products.map(product => ( <div key={product._id} className='mr-5 relative'>
                    ...
                    <p className='absolute bottom-0 left-0 right-0 h-16 py-2 bg-black bg-opacity-70 tracking-wide text-center font-semibold text-xl text-dashPrimary flex items-center justify-center'><span>{product?.title}</span></p>
                </div>
