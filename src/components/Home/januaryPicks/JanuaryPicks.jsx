        ...
        {slicedData.map((monthsPicks, index) => (
          <div className=" h-fit group" key={index}>
            <div className=" h-80 relative overflow-hidden">
              ...
              <div className=" text-white absolute h-full w-full bg-black/50 flex flex-col items-start justify-center -bottom-10 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-500">
