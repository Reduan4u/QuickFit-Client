          ...
          <div className=" md:text-5xl text-3xl md:w-11/12 mx-auto font-bold  text-left  absolute  text-white flex flex-col lg:pl-40 md:pl-24 pl-18  px-10 justify-center h-full">
            <div>
              <motion.h2
                ...
                className="md:text-4xl text-2xl text-primary font-bold"
              >
                <span className="md:text-5xl text-3xl ">QuickFit </span> <br />for Your <span className="text-one"> Health,</span><br />Not Only <span className="text-one"> Fitness.</span>
              </motion.h2>
              <motion.h2
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.7 }}
                className="text-black md:text-lg text-sm text- pt-4"
              >
            ...
            <motion.div
              ...
              className="flex items-center text-end gap-3 pt-24">
              <h1 className="text-black  font-normal md:text-lg text-sm">Contact with us: </h1>
          ...
          <div className=" md:text-5xl text-3xl md:w-11/12 mx-auto font-bold  text-left  absolute  text-white flex flex-col lg:pl-40 md:pl-24 pl-18 px-10 justify-center h-full">
            <div>
              ...
              <motion.h2
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.7 }}
                className="text-black md:text-lg text-sm pt-4"
              >
                It has survived not only five Centuries but also Generations
              </motion.h2>
            </div>
        ...
        <SwiperSlide>
          <div className=" md:text-5xl text-3xl md:w-11/12 mx-auto font-bold  text-left  absolute  text-white flex flex-col lg:pl-40 md:pl-24 pl-18 px-10 justify-center h-full">
            <motion.h2
              ...
              whileInView={"show"}
              viewport={{ once: false, amount: 0.7 }}
              className="md:text-4xl text-2xl text-white text-right font-bold"
            >
              <span className="md:text-5xl text-3xl ">QuickFit </span> <br />For Your <span className="text-two"> Health,</span><br />Not Only <span className="text-one"> Fitness.</span>
            </motion.h2>
            <motion.h2
              variants={fadeIn("up", 0.9)}
              initial="hidden"
              whileInView={"show"}
              viewport={{ once: false, amount: 0.7 }}
              className="text-white md:text-lg text-sm pt-4 text-right"
            >
              It has survived not only five Centuries but also Generations
            </motion.h2>
            <motion.div
              ...
              whileInView={"show"}
              viewport={{ once: false, amount: 0.2 }}
              className="flex items-center justify-end text-end gap-3 pt-24">
              <h1 className="text-white font-normal md:text-lg text-sm">Contact with us: </h1>
