...
<button className="btn bg-white border-orange-600 border-2 rounded-md  hover:bg-orange-600 hover:text-white transform hover:scale-105 transition-all duration-300 " > Learn About the Team </button>
</div>
