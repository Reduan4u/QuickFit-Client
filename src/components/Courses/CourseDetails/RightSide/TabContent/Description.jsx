...
const Description = ({course}) => {
    return (
        <div>
            <div>
                <h1 className="text-2xl font-bold py-4">Description:</h1>
                <p className="text-justify">{course?.description}</p>
            </div>
            <div className="py-8">
                <h1 className="text-2xl font-bold py-4">Curriculum:</h1>
                <p className="text-justify">{course?.curriculum}</p>
            </div>
            <div>
                <h1 className="text-2xl font-bold py-4">Certification:</h1>
