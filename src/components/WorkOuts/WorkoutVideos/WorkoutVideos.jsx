    ...
    return (
        <div className="w-full mx-auto">
            ...
            {data.videos.map((video, index) => (
                <div key={data._id}>
                    <div className="py-5">
                        <section className="py-5 bg-black dark:bg-gray-900 w-full md:w-full lg:w-1/2 mx-auto border rounded-xl shadow-xl">
                            <div className="px-5">
                                <p className="text-primary dark:text-white block text-xl leading-snug mt-3 text-center">({index + 1}) {video.title}</p>
                                ...
                                <p className="text-gray-500 dark:text-gray-400 text-base py-1 my-0.5"> {video.subtitle}</p>
                                <div className="border-primary dark:border-gray-600 border border-b-0 my-1"></div>
                                <div className="relative z-40 flex items-center justify-end pt-2 gap-2">
                                    <a className="text-primary font-bold hover:text-blue-500" href="">
